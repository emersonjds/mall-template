...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-[#021218] duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
                  ...
                  return (
                    <React.Fragment>
                      ...
                      >
                        ...
                        <Link
                          to="/"
                          className="font-medium text-bodydark1 duration-300 ease-in-out hover:text-white"
                        >
                          Visao Geral
                          </Link>
